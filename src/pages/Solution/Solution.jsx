        ...
        <div className="Spl">
                ...
                <form action="">
                        <label htmlFor="email" className='Flex'><h4><span>*</span>Message:</h4>
                            <textarea className='Op' placeholder='We suggest your product requirements and company information here.'></textarea>
                        </label>
                    </form>
                </div>
                <div className="hre">
                    ...
                    <div className="Fore">
                        ...
                        <h6><a href="https://purchase.made-in-china.com/trade-service/quotation-request.html?lan=en&pv_id=1ir7dba2m9b&faw_id=1ir7dfmlt12d"><GiFishingNet />Post a Sourcing Request Now</a></h6>
                    </div>
                </div>
         </div>
      </div>
